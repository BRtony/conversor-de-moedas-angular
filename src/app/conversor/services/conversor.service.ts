...
export class ConversorService {
  // Nova url do fixer.io. Adiciona o parâmetro access_key, que é a chave de autenticação
  // private readonly BASE_URL = "http://api.fixer.io/latest";
  private readonly BASE_URL =
    "http://data.fixer.io/api/latest?access_key=85a751bc193cd5da720158058a7730f6";
